...
| Block A | Root-authorized change to `kernel.apparmor_restrict_unprivileged_userns`, followed by an unprivileged Bubblewrap uid-map verification; network-enabled Item 30 relaunch still failed | Host sysadmin | 2026-09-15 | CLOSED 2026-09-17: not available on this host; PI determined kernel remediation cannot be made and no second machine is available. Original events retained. |
