...
| Curator boundary probe | Rendered curator settings and a passing sandbox assertion | Curator / access renderer | 2026-09-15 | OPEN — `scripts/assert_sandbox.sh curator` exit 1: `rendered settings absent; run scripts/render_access.py curator` |
